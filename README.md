...
[![Build Status](https://travis-ci.org/P4Networking/netlink.png?branch=master)](https://travis-ci.org/P4Networking/netlink) [![GoDoc](https://godoc.org/github.com/P4Networking/netlink?status.svg)](https://godoc.org/github.com/P4Networking/netlink)
...
You can use go get command:
    ...
    go get github.com/P4Networking/netlink
...
Testing (requires root):
    ...
    sudo -E go test github.com/P4Networking/netlink
...
import (
    "fmt"
    "github.com/P4Networking/netlink"
)
